...
<%@ taglib uri="http://java.sun.com/jsp/jstl/sql" prefix="sql"%>
	...
	<script type="text/javascript" src="js/busRoute.js"></script>
		<!-- Dashboard Wrapper starts -->
		<div class="dashboard-wrapper">

			<!-- Top Bar starts -->
		<!-- 	<div class="top-bar">
				<div class="page-title" id="headId">Van Route</div>
			</div> -->
		...
		<li><a href="busRouteFee"></a>Van Route Fees</a></li>
	</ol>
						<div class="row">
...
<%-- 									<%${message} %> --%>
			...
			<div class="panel panel-info">
					<div class="panel-heading">
						<h4>Van Route Fees</h4>
					</div>
                    
                    
                     <div class="panel-body">
									<form:form action="addBusRouteFee.htm" commandName="busRouteFee" method="post" id="cls-form" class="form-horizontal">
											<div class="form-group">
												<label for="inputEmail3" class="col-sm-4 control-label">Board Name<span style="color: red;">*</span></label>
												<div class="col-sm-5">
													<form:select path="boardId" name="boardId" tabindex="1"	onchange="classNameFilter()"	class="form-control" required="true">
											...
											<div class="form-group">
												...
												<div class="col-sm-5">
													<form:select path="classId" name="classId" tabindex="2"	onchange="sectionFilter()"	class="form-control" required="true">
...
<%-- 														<form:options items="${allClasses}"></form:options> --%>
											...
											<div class="form-group">
												...
												<div class="col-sm-5">
													<form:select path="sectionId" name="sectionId" tabindex="3"	onchange="mediumFilter()"	class="form-control" required="true">
...
<%-- 														<form:options items="${allSection}"></form:options> --%>
											...
											<div class="form-group">
												...
												<div class="col-sm-5">
													<form:select path="mediumId" name="mediumId" tabindex="4"	class="form-control" required="true">
...
<%-- 														<form:options items="${mediam}"></form:options> --%>
											...
											<div class="form-group">
											    <label for="inputEmail3" class="col-sm-4 control-label">Rout Name<span style="color: red;">*</span></label>
											    <div class="col-lg-6 col-md-6 col-sm-6">
													<form:select path="routeId" name="routeId" class="form-control nospecialCharacter onlyCharacters" placeholder="Route Name" >
													<form:option value="">-- Choose Van Route --</form:option>
														<form:options items="${busRouteNames}"></form:options>
													</form:select>
													<span class="name_error" id="name_error"></span>
												</div>
											</div>
											<div class="form-group">
											    <label for="inputEmail3" class="col-sm-4 control-label">Route Fees<span style="color: red;">*</span></label>
											    <div class="col-lg-6 col-md-6 col-sm-6">
													<form:input path="busFee" name="busFee" class="form-control numericOnly"   placeholder="Route Fees" />
													<span class="name_error" id="name_error"></span>
												</div>
											</div>
											<form:hidden path="id"/>
													...
													<div class="col-sm-12">
 														<table id="basicExample" class="table table-striped table-condensed table-bordered no-margin dataTable" role="grid" aria-describedby="basicExample_info">
															<thead>
																...
																<th class="sorting_asc" tabindex="0" aria-controls="basicExample" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending">Section</th>
																<th class="sorting_asc" tabindex="0" aria-controls="basicExample" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending">Medium</th>
																	<th class="sorting_asc" tabindex="0" aria-controls="basicExample" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending">Route Name</th>
																	<th class="sorting_asc" tabindex="0" aria-controls="basicExample" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending">Fees</th>
