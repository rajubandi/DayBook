                     ...
                     <div class="panel-body">
									...
									<div class="">
											...
											<div class="form-group">
											    ...
											    <div class="col-sm-6">
												    <form:select path="boardId"  onchange="classNameFilter()" class="form-control" required="true">
											...
											<div class="form-group">
											    ...
											    <div class="col-sm-6">
												    <form:select path="classId"  class="form-control" required="true">
														<form:option value="">-- Choose Class --</form:option>
<%-- 														<form:options items="${allClasses}"></form:options> --%>
													</form:select>
<%-- 													<form:input path="className" class="form-control"  placeholder="Enter Class/Branch" required="true"/> --%>
											...
											<div class="form-group">
											    ...
											    <div class="col-sm-6">
												    <%-- <form:select path="section"  class="form-control" required="true">
														<form:option value="">-- Choose Section --</form:option>
														<form:options items="${allSection}"></form:options>
													</form:select> --%>
													<form:input path="section" class="form-control nospecialCharacter" placeholder="Section" required="true"/>
										...
										<%-- <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
											<div class="form-group">
											    ...
											    <div class="col-sm-8">
													<form:input path="fee" class="form-control numericOnly"  placeholder="Enter Fee for the Class" required="true"/>
