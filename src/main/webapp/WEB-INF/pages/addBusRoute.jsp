...
<%@ taglib uri="http://java.sun.com/jsp/jstl/sql" prefix="sql"%>
	...
	<script type="text/javascript" src="js/addBusRoute.js"></script>
		...
		<li><a href="addBusRoute"></a>Van Route</a></li>
	</ol>
						<div class="row">
...
<%-- 									<%${message} %> --%>
			...
			<div class="panel panel-info">
					<div class="panel-heading">
						<h4>Van Route Name</h4>
					</div>
                    
                    
                     <div class="panel-body">
									<form:form action="addBusRouteName.htm" commandName="busRoute" method="post" id="cls-form" class="form-horizontal">
											
											<div class="form-group">
											    <label for="inputEmail3" class="col-sm-4 control-label">Rout Name</label>
											    <div class="col-lg-6 col-md-6 col-sm-6">
													<form:input path="routeName" class="form-control nospecialCharacter onlyCharacters" placeholder="Route Name" />
											...
											<form:hidden path="id"/>
												...
												<div class="form-group">
													...
													<%
														String message = null;
														message=(String)session.getAttribute("rounteNameDeleted");
												        if(message!=null)
												        {
															out.println("<span class='animated fadeOut' style='animation-iteration-count: 1;animation-duration: 10s;color: red;'>"+message+"</span>");
															session.setAttribute("rounteNameDeleted", null);
														}
											        %>
													</div>
													
													<span id="busrouteDeletemsg" class='animated fadeOut' style='animation-iteration-count: 1;animation-duration: 10s;color: red;'></span>
												</div>
									</form:form></div></div>
									</div>
