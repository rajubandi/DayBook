...
<%@ taglib uri="http://java.sun.com/jsp/jstl/sql" prefix="sql"%>
	...
	<script type="text/javascript" src="js/academicYear.js"></script>
...
<script src="http://ajax.googleapis.com/ajax/libs/jqueryui/1.11.1/jquery-ui.min.js"></script>
		...
		<div class="dashboard-wrapper">
			...
			<!-- Top Bar starts -->
			<div class="top-bar">
				<div class="page-title" id="headId">Academic Year Creation</div>
			</div>
		...
		<li><a href="academicYearHome"></a>Academic Year Creation</a></li>
	</ol>
						<div class="row">
			...
			<div class="panel panel-info">
					<div class="panel-heading">
                     ...
                     <div class="panel-body">
									<form:form action="addAcademicYear.htm" commandName="academicYear" method="post" id="cls-form" class="form-horizontal">
									
											<div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
											  	<div class="form-group">
												    <label  class="col-sm-4 control-label">Start Year<span style="color: red;">*</span></label>
												    <div class="col-sm-8">
												    
														<form:input path="startYear"  autocomplete="off" data-format="yyyy" placeholder="Date" class="form-control validate"   onfocus="removeBorder(this.id)" />
											...
											<div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
											  	<div class="form-group">
												    <label  class="col-sm-4 control-label">End Year <span style="color: red;">*</span></label>
												    <div class="col-sm-8">
														<form:input path="endYear"  autocomplete="off" data-format="yyyy" placeholder="Date" class="form-control validate"  onfocus="removeBorder(this.id)" />
											...
											<%-- <div class="form-group">
											    <label for="inputEmail3" class="col-sm-4 control-label">Academic Year</label>
											    <div class="col-lg-6 col-md-6 col-sm-6">
													<form:input type="text"    path="name" class="form-control" placeholder="Academic Year XXXX - XXXX" required="true"/>
												...
												<div class="row">
													<div class="col-sm-12">
 														<table id="basicExample" class="table table-striped table-condensed table-bordered no-margin dataTable" role="grid" aria-describedby="basicExample_info">
															<thead>
																<tr role="row">
																	<th class="sorting_asc" tabindex="0" aria-controls="basicExample" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending">Academic Year</th>
